...
from utils_old import SegmentationMetric
...
if __name__ == "__main__":
    ...
    save_name = 'DRDB_CAM_SIM'
    Method = 'DRDB_CAM_SIM'
    respth = './model'
    log_dir = os.path.join(respth, save_name)
    os.makedirs(log_dir, exist_ok=True)
    datapth='/home/wenhao/projects/SeAFusion/output'
    setup_logger(log_dir)
    evaluate(respth=respth, dspth=datapth, Method=Method, save_pth='./model/DRDB_CAM_SIM/model_final.pth')